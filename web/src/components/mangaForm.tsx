    ...
    <div className="justify-items-center bg-gray-50 dark:bg-gray-900">
                ...
                <div className="flex flex-wrap justify-around">
                  ...
                  <div>
                    ...
                    >
                      ...
                      <option value={"literature-eng"}>
                        - English Literature
                      </option>
                      <option value={"literature-non-eng"}>
                        - Non English Literature
                      </option>
                      <option value={"literature-raw"}>- Raw Literature</option>
                    </select>
                  </div>
                </div>
      ...
      >
        <TorrentTable
          torrents={results}
          options={{
            baseDir: customDir.trim() === "" ? "Manga" : customDir,
            url: false,
          }}
        />
      </section>
